...
//Code Here
var lastItemRemoved = arr.splice(5, 1)
console.log(arr)
////////// PROBLEM 3 //////////
...
/*
  Determine if the letter grade of the given variable 'score'. If the variable is a 
  90 or above, console log an 'A', between 80 and 89, console log a 'B', between 70 
  and 79, 'C', between 60 and 69, 'D', and anything below 60 should console log an 'F'.
*/
...
// // Use an if statement to check the length of the 'myFavoriteNumbers' array. If it's 
// less than 7, log 'There are not enough elements in this array' to the console. If the 
// length is more than 7, reassign the value of 'someNum' to the value of the 7th element 
...
// // Use a for-loop to iterate through 'listOfNumbers', checking to see if each 
// number is divisible by 3. If it is, console.log '{number} is divisible by 3.'
